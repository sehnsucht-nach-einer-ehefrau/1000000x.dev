			...
			<>
				...
				>
					...
					<div className="flex flex-col items-center space-y-4">
						...
						<div data-magnetic-target><SidebarIcon icon={Coffee} text="Buy me a coffee" href="https://www.buymeacoffee.com/sehnsucht" /></div>
		...
		<>
			...
			>
				...
				<div className="flex items-center justify-around">
					...
					<div data-magnetic-target className="flex-1"><CollapsedSidebarIcon icon={Coffee} href="https://www.buymeacoffee.com/sehnsucht" /></div>
